...
urlpatterns = [
    ...
    path('quienes-somos/<str:titulo>/<int:codigo>/', nacionalidades_views.detalle_nacionalidad, name='detalle_nacionalidad'),
    ...
    path('eliminar_nacionalidad/<int:nacCodigo>/', nacionalidades_views.eliminar_nacionalidad, name='eliminar_nacionalidad'),
